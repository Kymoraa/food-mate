...
import msc.project.foodmate.view.FavouritesAdapter;
...
/*
display the cuisines that the user marks as favourite
 */
public class MainFavourites extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //set the favourites to the favourites adapter if the cusines exist in the favourites database
        // under the user id of the current user
    ...
    ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT | ItemTouchHelper.DOWN | ItemTouchHelper.UP) {
        ...
        public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
            ...
            try {
                ...
                //remove item from favourites db at position(i)
                ...
                //in case of a failure in the process
                //catch the exception
    ...
    private void toggleEmptyList() {
        //if no favourites exist, display the textview
